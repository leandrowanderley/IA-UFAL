...
clf_c45 = DecisionTreeClassifier(criterion='entropy', max_depth=3)
clf_c45.fit(x, y)

tree_rules_c45 = export_text(clf_c45, feature_names=x.columns.tolist())
print("Árvore de Decisão (Regras - C4.5):\n", tree_rules_c45)

plt.figure(figsize=(12,8))
tree.plot_tree(clf_c45, filled=True, feature_names=x.columns, class_names=le.classes_)
plt.show()
