...
tree_rules_id3 = export_text(clf_id3, feature_names=x.columns.tolist())
print("Árvore de Decisão (Regras - ID3):\n", tree_rules_id3)

plt.figure(figsize=(12,8))
tree.plot_tree(clf_id3, filled=True, feature_names=x.columns, class_names=le.classes_)
plt.show()
